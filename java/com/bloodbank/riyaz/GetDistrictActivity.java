...
/**
 * Created by riyaz-1396 on 06/04/17.
 */

public class GetDistrictActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Districts");
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Districts");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        if (getIntent() != null && getIntent().hasExtra("provinceName")) {
    ...
    protected void onStart() {
        ...
        try {
            Set<String> provinceSet = AppController.getInstance().fetchDetails(provinceName);
    ...
    public class RegionAdapter extends RecyclerView.Adapter<RegionAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            LinearLayout provinceDetails;

            public MyViewHolder(View view) {
                super(view);
                provinceName = (TextView) view.findViewById(R.id.country_name);
                provinceDetails = (LinearLayout) view.findViewById(R.id.country_details);
        ...
        public void onBindViewHolder(RegionAdapter.MyViewHolder holder, final int position) {
            try {
                ...
                holder.provinceName.setText(name.get(position));
                holder.provinceDetails.setTag(name.get(position));
                holder.provinceDetails.setOnClickListener(getLocDetLis);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    View.OnClickListener getLocDetLis = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent profilePage = new Intent(GetDistrictActivity.this, GetProfileActivity.class);
            profilePage.putExtra("distName", v.getTag().toString());
            profilePage.putExtra("provinceName", provinceName);
            profilePage.putExtra("countryName", getIntent().getStringExtra("countryName"));
            GetDistrictActivity.this.startActivity(profilePage);
